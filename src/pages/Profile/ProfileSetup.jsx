                      ...
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <div className="flex items-center space-x-3">
                          <select
                            ...
                            className="text-sm border border-gray-600 rounded px-2 py-1 bg-gray-700 text-white"
                          >
          ...
          {currentStep === 2 && (
            <div>
              ...
              <button
                ...
                className="w-full p-4 border-2 border-dashed border-gray-600 rounded-lg text-gray-300 hover:border-white hover:text-white transition-colors"
              >
                + Add Learning Goal
              </button>
            </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center space-x-4">
                  <input
                    ...
                    className="flex-1"
                  />
                  <span className="text-lg font-medium text-white w-20">
